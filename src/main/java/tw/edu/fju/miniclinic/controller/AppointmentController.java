...
public class AppointmentController {
    ...
    public String submitAppointment(
            @Valid @ModelAttribute AppointmentForm form,   // ← 加 @Valid
        ...
        Patient patient = patientRepo.findByChartNo(form.getChartNo());
        Doctor  doctor  = doctorRepo.findByDoctorId(form.getDoctorId());

        // 步驟 2：驗證——找不到就回表單顯示錯誤
        if (patient == null || doctor == null || form.getApptDate() == null || form.getApptDate().isBlank()) {
